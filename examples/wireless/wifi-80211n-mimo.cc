...
{
  std::ofstream file ("80211n-siso-throughput.plt");
  ...
  Gnuplot plot = Gnuplot ("80211n-siso-throughput.eps");
  uint8_t mcsIdx[8] = {1, 1, 1, 1, 1, 1, 1, 1};
      ...
      for (double d = 0; d <= 100; ) //distance
        {
          ...
          uint8_t nStreams = mcsIdx[i]; //number of MIMO streams
